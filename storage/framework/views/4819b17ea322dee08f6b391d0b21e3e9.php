                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                <button type="button" class="btn nav-link text-whitedropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><button class="dropdown-item activebg-purple" type="button"><small>Latest
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><button class="dropdown-item activebg-purple" type="button"><small><i
                                                    class="bi-brightness-high-fillme-2"></i>Light</small></button></li>
                                    <li><button class="dropdown-item" type="button"><small><i
                                                    class="bi-moon-stars-fillme-2"></i>Dark</small></button></li>
                                    <li><button class="dropdown-item" type="button"><small><i
                                                    class="bi-circle-halfme-2"></i>Auto</small></button></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="col-md-7 order-md-1">
                    ...
                    <div class="row">
                        <div class="d-flex flex-column flex-md-row">
                            <button type="button" class="btn bg-purple text-whitebtn-lg mb-3 me-md-3 px-4 py-3">Get
                                Started</button>
...
<?php /**PATH C:\xampp\htdocs\modul4Laravel\laravel\resources\views/cloning.blade.php ENDPATH**/ ?>